...
public class FindClientByCityAndLastname implements Command {
    private String commandNameRegex = "^cl$|^cln$|^сл$|^слн$"; //regex возможных имен команды
    private int numberOfArgs = 2;
    private String[] argsRegex = new String[]{"^[a-zа-я]+\\*?$|^\\*[a-zа-я]+$", "^[a-zа-я]+\\*?$|^\\*[a-zа-я]+$"};
    private String queryBasisString = "SELECT * FROM CLIENT WHERE CITY RLIKE('%s') AND LAST_NAME RLIKE('%s');";
    private String[] args;
    private String queryString;

    public FindClientByCityAndLastname() {
    }
